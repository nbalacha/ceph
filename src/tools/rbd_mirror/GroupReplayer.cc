...
//FIXME: Bootstrapper should return an error if the local is primary.
// It should not create the image replayers in this case.
...
void GroupReplayer<I>::shut_down(int r) {
  ...
  Context *ctx = new LambdaContext(
    [this, r](int _r) {
// FIXME: This overwrites the split-brain error.
